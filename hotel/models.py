...
class Room(models.Model):
    ...
    status = models.CharField(max_length=1, choices=CHECKLIST_OPTIONS, verbose_name='Статус занятости')
    id_room_type = models.ForeignKey(Room_type, on_delete=models.CASCADE, verbose_name='Тип номера')

    def __str__(self):
        return '{} - {}'.format(self.room_number, self.room_floor)
...
class Booking(models.Model):
    ...
    def __str__(self):
        return '{} {}'.format(self.id_guest, self.booking_date)
